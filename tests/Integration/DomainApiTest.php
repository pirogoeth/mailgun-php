...
class DomainApiTest extends TestCase
{
    ...
    public function testDomainsList()
    {
        ...
        $domainList = $mg->getDomainApi()->list();
        $found = false;
     ...
     * @group negative
     */
    public function testCreateCredential_BadPassword_Long()
    {
        $mg = $this->getMailgunClient();
     ...
     * @group negative
     */
    public function testCreateCredential_BadPassword_Short()
    {
        $mg = $this->getMailgunClient();
     ...
     * @group negative
     */
    public function testListCredentials_BadDomain()
    {
        $mg = $this->getMailgunClient();
     ...
     * @group negative
     */
    public function testUpdateCredential_BadPassword_Long()
    {
        $login = 'user-test@'.$this->testDomain;
     ...
     * @group negative
     */
    public function testUpdateCredential_BadPassword_Short()
    {
        $login = 'user-test@'.$this->testDomain;
     ...
     * @group negative
     */
    public function testRemoveCredential_NoExist()
    {
